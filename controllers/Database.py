...
class DatabaseController:
    ...
    def insertData(self):
        ...
        self.session.add_all([
            ...
            CambioEstado(fechaHoraInicio='2023-06-26 12:00:00', fechaHoraFin=None, estadoId = 1, llamadaId = 2),
            CambioEstado(fechaHoraInicio='2023-06-26 12:19:36', fechaHoraFin=None, estadoId = 1, llamadaId = 3),
            CambioEstado(fechaHoraInicio='2023-06-26 12:19:36', fechaHoraFin=None, estadoId = 1, llamadaId = 4),
            CambioEstado(fechaHoraInicio='2023-06-27 12:25:00', fechaHoraFin=None, estadoId = 1, llamadaId = 5),
