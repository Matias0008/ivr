...
class Tableview(ttk.Frame):
    ...
    def _build_search_frame(self):
        ...
        frame.pack(fill=X, side=TOP, pady=(0, 20))
        ttk.Label(frame, text=MessageCatalog.translate("Search")).pack(side=LEFT, padx=5)
        searchterm = ttk.Entry(frame, textvariable=self._searchcriteria, font=("JetBrains Mono", 14))
    ...
    def _build_pagination_frame(self):
        ...
        pageframe.pack(fill=X, anchor=N, pady=(10, 0))
        ttk.Button(
            pageframe,
            text=MessageCatalog.translate("⎌"),
            command=self.reset_table,
        ...
        index = ttk.Entry(pageframe, textvariable=self._pageindex, width=4, font=("JetBrains Mono", 14))
